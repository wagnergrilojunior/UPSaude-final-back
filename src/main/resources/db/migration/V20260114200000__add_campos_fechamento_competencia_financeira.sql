...
-- Adicionar constraint de foreign key para documento_bpa_fechamento (se a tabela documento_faturamento existir)
-- Nota: A constraint será adicionada apenas se a tabela documento_faturamento existir
-- Isso evita erros em ambientes onde a tabela ainda não foi criada

-- Adicionar índice para status (se não existir)
