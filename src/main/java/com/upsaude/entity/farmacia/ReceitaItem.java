...
@Entity
@Table(name = "receita_itens", schema = "public", uniqueConstraints = {
...
public class ReceitaItem extends BaseEntity {
        ...
        @ManyToOne(fetch = FetchType.LAZY)
        @JoinColumn(name = "sigtap_procedimento_id", nullable = true)
