...
@Table(
    ...
    schema = "public",
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_baixa_receber_idempotency", columnNames = {"tenant_id", "idempotency_key"})
    },
    indexes = {
        @Index(name = "idx_baixa_receber_titulo", columnList = "titulo_receber_id")
    }
)
@Data
