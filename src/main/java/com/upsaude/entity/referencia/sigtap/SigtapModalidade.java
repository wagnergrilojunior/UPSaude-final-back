...
/**
 * Modalidade do SIGTAP.
 */
@Entity
@Table(
        name = "sigtap_modalidade",
        schema = "public",
        uniqueConstraints = {
                @UniqueConstraint(name = "uk_sigtap_modalidade_codigo_comp", columnNames = {"codigo_oficial", "competencia_inicial"})
        },
        indexes = {
                @Index(name = "idx_sigtap_modalidade_nome", columnList = "nome")
        }
)
@Data
@EqualsAndHashCode(callSuper = true)
public class SigtapModalidade extends BaseEntityWithoutTenant {
