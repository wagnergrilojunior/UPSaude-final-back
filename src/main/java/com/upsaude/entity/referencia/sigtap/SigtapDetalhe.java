...
@Table(
        ...
        schema = "public",
        uniqueConstraints = {
                @UniqueConstraint(name = "uk_sigtap_detalhe_codigo_comp", columnNames = {"codigo_oficial", "competencia_inicial"})
        },
        indexes = {
                @Index(name = "idx_sigtap_detalhe_nome", columnList = "nome")
        }
)
@Data
@EqualsAndHashCode(callSuper = true)
public class SigtapDetalhe extends BaseEntityWithoutTenant {
