...
@RestController
@RequestMapping("/api/v1/financeiro/logs")
...
public class LogFinanceiroController {
    ...
    public ResponseEntity<LogFinanceiroResponse> criar(@Valid @RequestBody LogFinanceiroRequest request) {
        log.debug("REQUEST POST /api/v1/financeiro/logs - payload: {}", request);
        try {
    ...
    public ResponseEntity<Page<LogFinanceiroResponse>> listar(
            ...
            Pageable pageable) {
        log.debug("REQUEST GET /api/v1/financeiro/logs - pageable: {}", pageable);
        try {
    ...
    public ResponseEntity<LogFinanceiroResponse> obterPorId(
        ...
        log.debug("REQUEST GET /api/v1/financeiro/logs/{}", id);
        try {
    ...
    public ResponseEntity<LogFinanceiroResponse> atualizar(
        ...
        log.debug("REQUEST PUT /api/v1/financeiro/logs/{} - payload: {}", id, request);
        try {
    ...
    public ResponseEntity<Void> excluir(
            @Parameter(description = "ID do log", required = true)
            @PathVariable UUID id) {
        log.debug("REQUEST DELETE /api/v1/financeiro/logs/{}", id);
        try {
            service.excluir(id);
    ...
    public ResponseEntity<Void> inativar(
            @Parameter(description = "ID do log", required = true)
            @PathVariable UUID id) {
        log.debug("REQUEST PUT /api/v1/financeiro/logs/{}/inativar", id);
        try {
            service.inativar(id);
