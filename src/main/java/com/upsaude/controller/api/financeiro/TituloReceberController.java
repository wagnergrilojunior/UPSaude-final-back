...
@RestController
@RequestMapping("/v1/financeiro/titulos-receber")
...
public class TituloReceberController {
    ...
    public ResponseEntity<TituloReceberResponse> criar(@Valid @RequestBody TituloReceberRequest request) {
        log.debug("REQUEST POST /v1/financeiro/titulos-receber - payload: {}", request);
        try {
    ...
    public ResponseEntity<Page<TituloReceberResponse>> listar(
            ...
            Pageable pageable) {
        log.debug("REQUEST GET /v1/financeiro/titulos-receber - pageable: {}", pageable);
        try {
    ...
    public ResponseEntity<TituloReceberResponse> obterPorId(
        ...
        log.debug("REQUEST GET /v1/financeiro/titulos-receber/{}", id);
        try {
    ...
    public ResponseEntity<TituloReceberResponse> atualizar(
        ...
        log.debug("REQUEST PUT /v1/financeiro/titulos-receber/{} - payload: {}", id, request);
        try {
    ...
    public ResponseEntity<Void> excluir(
            @Parameter(description = "ID do título", required = true)
            @PathVariable UUID id) {
        log.debug("REQUEST DELETE /v1/financeiro/titulos-receber/{}", id);
        try {
            service.excluir(id);
    ...
    public ResponseEntity<Void> inativar(
            @Parameter(description = "ID do título", required = true)
            @PathVariable UUID id) {
        log.debug("REQUEST PUT /v1/financeiro/titulos-receber/{}/inativar", id);
        try {
            service.inativar(id);
