...
@Component("filaEsperaCacheKeyGenerator")
@RequiredArgsConstructor
public class FilaEsperaCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.filaEspera(tenantId, id));
    }
}
