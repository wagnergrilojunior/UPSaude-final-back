...
@Component("pacienteCacheKeyGenerator")
@RequiredArgsConstructor
public class PacienteCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        UUID pacienteId = (UUID) params[0];
        return Objects.requireNonNull((Object) CacheKeyUtil.paciente(tenantId, pacienteId));
    }
}
