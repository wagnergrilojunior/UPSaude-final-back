...
@Component("logsAuditoriaCacheKeyGenerator")
@RequiredArgsConstructor
public class LogsAuditoriaCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.logAuditoria(tenantId, id));
    }
}
