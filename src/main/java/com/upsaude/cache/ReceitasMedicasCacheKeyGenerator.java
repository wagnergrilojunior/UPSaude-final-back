...
@Component("receitasMedicasCacheKeyGenerator")
@RequiredArgsConstructor
public class ReceitasMedicasCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.receitaMedica(tenantId, id));
    }
}
