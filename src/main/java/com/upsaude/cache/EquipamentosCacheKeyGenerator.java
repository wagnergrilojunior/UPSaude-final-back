...
@Component("equipamentosCacheKeyGenerator")
@RequiredArgsConstructor
public class EquipamentosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.equipamento(tenantId, id));
    }
}
