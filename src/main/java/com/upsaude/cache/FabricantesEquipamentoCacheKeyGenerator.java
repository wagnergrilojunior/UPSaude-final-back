...
@Component("fabricantesEquipamentoCacheKeyGenerator")
@RequiredArgsConstructor
public class FabricantesEquipamentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.fabricanteEquipamento(id));
    }
}
