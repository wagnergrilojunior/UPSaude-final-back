...
@Component("consultaPreNatalCacheKeyGenerator")
@RequiredArgsConstructor
public class ConsultaPreNatalCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.consultaPreNatal(tenantId, id));
    }
}
