...
@Component("servicosEstabelecimentoCacheKeyGenerator")
@RequiredArgsConstructor
public class ServicosEstabelecimentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.servicoEstabelecimento(tenantId, id));
    }
}
