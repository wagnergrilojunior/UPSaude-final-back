...
@Component("cirurgiaCacheKeyGenerator")
@RequiredArgsConstructor
public class CirurgiaCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.cirurgia(tenantId, id));
    }
}
