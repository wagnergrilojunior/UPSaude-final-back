...
@Component("tratamentosOdontologicosCacheKeyGenerator")
@RequiredArgsConstructor
public class TratamentosOdontologicosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.tratamentoOdontologico(tenantId, id));
    }
}
