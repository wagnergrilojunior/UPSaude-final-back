...
@Component("cuidadosEnfermagemCacheKeyGenerator")
@RequiredArgsConstructor
public class CuidadosEnfermagemCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.cuidadoEnfermagem(tenantId, id));
    }
}
