...
@Component("infraestruturaEstabelecimentoCacheKeyGenerator")
@RequiredArgsConstructor
public class InfraestruturaEstabelecimentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.infraestruturaEstabelecimento(tenantId, id));
    }
}
