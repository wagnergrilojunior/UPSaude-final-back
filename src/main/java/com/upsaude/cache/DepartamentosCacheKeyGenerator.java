...
@Component("departamentosCacheKeyGenerator")
@RequiredArgsConstructor
public class DepartamentosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.departamento(tenantId, id));
    }
}
