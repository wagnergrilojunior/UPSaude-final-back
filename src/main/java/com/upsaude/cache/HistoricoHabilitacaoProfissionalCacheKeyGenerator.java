...
@Component("historicoHabilitacaoProfissionalCacheKeyGenerator")
@RequiredArgsConstructor
public class HistoricoHabilitacaoProfissionalCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.historicoHabilitacaoProfissional(tenantId, id));
    }
}
