...
@Component("fabricantesMedicamentoCacheKeyGenerator")
@RequiredArgsConstructor
public class FabricantesMedicamentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.fabricanteMedicamento(id));
    }
}
