...
@Component("configuracaoEstabelecimentoCacheKeyGenerator")
@RequiredArgsConstructor
public class ConfiguracaoEstabelecimentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.configuracaoEstabelecimento(tenantId, id));
    }
}
