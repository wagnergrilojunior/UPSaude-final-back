...
@Component("perfisUsuariosCacheKeyGenerator")
@RequiredArgsConstructor
public class PerfisUsuariosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.perfilUsuario(tenantId, id));
    }
}
