...
@Component("procedimentosOdontologicosCacheKeyGenerator")
@RequiredArgsConstructor
public class ProcedimentosOdontologicosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.procedimentoOdontologico(tenantId, id));
    }
}
