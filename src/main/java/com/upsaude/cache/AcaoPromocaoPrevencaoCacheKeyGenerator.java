...
@Component("acaoPromocaoPrevencaoCacheKeyGenerator")
@RequiredArgsConstructor
public class AcaoPromocaoPrevencaoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.acaoPromocaoPrevencao(tenantId, id));
    }
}
