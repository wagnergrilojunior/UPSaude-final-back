...
@Component("visitasDomiciliaresCacheKeyGenerator")
@RequiredArgsConstructor
public class VisitasDomiciliaresCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.visitaDomiciliar(tenantId, id));
    }
}
