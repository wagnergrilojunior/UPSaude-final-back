...
@Component("fabricantesVacinaCacheKeyGenerator")
@RequiredArgsConstructor
public class FabricantesVacinaCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.fabricanteVacina(id));
    }
}
