...
@Component("vacinacoesCacheKeyGenerator")
@RequiredArgsConstructor
public class VacinacoesCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.vacinacao(tenantId, id));
    }
}
