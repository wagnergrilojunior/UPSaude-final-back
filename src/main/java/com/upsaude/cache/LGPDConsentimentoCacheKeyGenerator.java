...
@Component("lgpdConsentimentoCacheKeyGenerator")
@RequiredArgsConstructor
public class LGPDConsentimentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.lgpdConsentimento(tenantId, id));
    }
}
