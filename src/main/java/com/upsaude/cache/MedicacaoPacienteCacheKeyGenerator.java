...
@Component("medicacaoPacienteCacheKeyGenerator")
@RequiredArgsConstructor
public class MedicacaoPacienteCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.medicacaoPaciente(tenantId, id));
    }
}
