...
@Component("procedimentoCirurgicoCacheKeyGenerator")
@RequiredArgsConstructor
public class ProcedimentoCirurgicoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.procedimentoCirurgico(tenantId, id));
    }
}
