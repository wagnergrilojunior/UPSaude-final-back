...
@Component("planejamentoFamiliarCacheKeyGenerator")
@RequiredArgsConstructor
public class PlanejamentoFamiliarCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.planejamentoFamiliar(tenantId, id));
    }
}
