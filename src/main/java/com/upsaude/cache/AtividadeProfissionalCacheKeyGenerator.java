...
@Component("atividadeProfissionalCacheKeyGenerator")
@RequiredArgsConstructor
public class AtividadeProfissionalCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.atividadeProfissional(tenantId, id));
    }
}
