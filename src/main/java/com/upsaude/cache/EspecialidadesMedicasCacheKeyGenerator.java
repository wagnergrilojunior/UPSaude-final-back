...
@Component("especialidadesMedicasCacheKeyGenerator")
@RequiredArgsConstructor
public class EspecialidadesMedicasCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.especialidadeMedica(id));
    }
}
