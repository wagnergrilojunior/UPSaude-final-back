...
@Component("consultasCacheKeyGenerator")
@RequiredArgsConstructor
public class ConsultasCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.consulta(tenantId, id));
    }
}
