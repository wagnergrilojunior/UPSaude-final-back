...
@Component("escalaTrabalhoCacheKeyGenerator")
@RequiredArgsConstructor
public class EscalaTrabalhoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.escalaTrabalho(tenantId, id));
    }
}
