...
@Component("medicaoClinicaCacheKeyGenerator")
@RequiredArgsConstructor
public class MedicaoClinicaCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.medicaoClinica(tenantId, id));
    }
}
