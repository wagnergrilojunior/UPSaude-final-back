...
@Component("controlePontoCacheKeyGenerator")
@RequiredArgsConstructor
public class ControlePontoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.controlePonto(tenantId, id));
    }
}
