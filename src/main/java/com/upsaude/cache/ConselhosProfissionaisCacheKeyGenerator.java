...
@Component("conselhosProfissionaisCacheKeyGenerator")
@RequiredArgsConstructor
public class ConselhosProfissionaisCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.conselhoProfissional(id));
    }
}
