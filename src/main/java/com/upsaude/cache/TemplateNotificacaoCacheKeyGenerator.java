...
@Component("templateNotificacaoCacheKeyGenerator")
@RequiredArgsConstructor
public class TemplateNotificacaoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.templateNotificacao(tenantId, id));
    }
}
