...
@Component("profissionaisSaudeCacheKeyGenerator")
@RequiredArgsConstructor
public class ProfissionaisSaudeCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        UUID profissionalId = (UUID) params[0];
        return Objects.requireNonNull((Object) CacheKeyUtil.profissionalSaude(tenantId, profissionalId));
    }
}
