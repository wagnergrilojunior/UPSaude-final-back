...
@Component("atendimentoCacheKeyGenerator")
@RequiredArgsConstructor
public class AtendimentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.atendimento(tenantId, id));
    }
}
