...
@Component("estabelecimentosCacheKeyGenerator")
@RequiredArgsConstructor
public class EstabelecimentosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.estabelecimento(tenantId, id));
    }
}
