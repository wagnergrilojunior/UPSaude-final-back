...
@Component("faltaCacheKeyGenerator")
@RequiredArgsConstructor
public class FaltaCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.falta(tenantId, id));
    }
}
