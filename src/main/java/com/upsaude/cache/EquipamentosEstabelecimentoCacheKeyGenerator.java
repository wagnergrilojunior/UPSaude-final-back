...
@Component("equipamentosEstabelecimentoCacheKeyGenerator")
@RequiredArgsConstructor
public class EquipamentosEstabelecimentoCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.equipamentoEstabelecimento(tenantId, id));
    }
}
