...
@Component("movimentacoesEstoqueCacheKeyGenerator")
@RequiredArgsConstructor
public class MovimentacoesEstoqueCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.movimentacaoEstoque(tenantId, id));
    }
}
