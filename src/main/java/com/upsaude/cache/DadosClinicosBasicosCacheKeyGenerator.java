...
@Component("dadosClinicosBasicosCacheKeyGenerator")
@RequiredArgsConstructor
public class DadosClinicosBasicosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.dadosClinicosBasicos(tenantId, id));
    }
}
