...
@Component("dadosSociodemograficosCacheKeyGenerator")
@RequiredArgsConstructor
public class DadosSociodemograficosCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.dadosSociodemograficos(tenantId, id));
    }
}
