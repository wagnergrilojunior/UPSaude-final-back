...
@Component("integracaoGovCacheKeyGenerator")
@RequiredArgsConstructor
public class IntegracaoGovCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.integracaoGov(tenantId, id));
    }
}
