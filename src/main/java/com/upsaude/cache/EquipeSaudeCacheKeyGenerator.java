...
@Component("equipeSaudeCacheKeyGenerator")
@RequiredArgsConstructor
public class EquipeSaudeCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.equipeSaude(tenantId, id));
    }
}
