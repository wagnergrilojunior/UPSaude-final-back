...
@Component("estoquesVacinaCacheKeyGenerator")
@RequiredArgsConstructor
public class EstoquesVacinaCacheKeyGenerator implements KeyGenerator {
    ...
    public @NonNull Object generate(@NonNull Object target, @NonNull Method method, @NonNull Object... params) {
        ...
        return Objects.requireNonNull((Object) CacheKeyUtil.estoqueVacina(tenantId, id));
    }
}
