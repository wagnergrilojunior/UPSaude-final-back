...
public interface ProfissionaisSaudeRepository extends JpaRepository<ProfissionaisSaude, UUID> {
    ...
    /**
     * Busca todos os profissionais de saúde de um estabelecimento.
     *
     * @param estabelecimentoId ID do estabelecimento
     * @param pageable informações de paginação
     * @return página de profissionais do estabelecimento
     */
    Page<ProfissionaisSaude> findByEstabelecimentoId(UUID estabelecimentoId, Pageable pageable);
    ...
    /**
     * Busca todos os profissionais de saúde de um estabelecimento e tenant.
     *
     * @param estabelecimentoId ID do estabelecimento
     * @param tenant tenant
     * @param pageable informações de paginação
     ...
     */
    Page<ProfissionaisSaude> findByEstabelecimentoIdAndTenant(UUID estabelecimentoId, Tenant tenant, Pageable pageable);
