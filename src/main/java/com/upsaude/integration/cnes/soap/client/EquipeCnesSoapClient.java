...
public class EquipeCnesSoapClient extends AbstractCnesSoapClient {
    ...
    public EquipeCnesSoapClient(WebServiceTemplate webServiceTemplate, CnesProperties properties) {
    ...
    public ResponsePesquisarEquipe pesquisarEquipes(String codigoCnes, int registroInicial, int quantidadeRegistros) {
        log.debug("Pesquisando equipes do estabelecimento CNES: {}, página: {}, tamanho: {}", codigoCnes, registroInicial, quantidadeRegistros);
