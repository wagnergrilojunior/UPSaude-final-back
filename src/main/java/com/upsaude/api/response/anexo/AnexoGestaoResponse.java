...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Response completo de anexo para gestão/admin")
public class AnexoGestaoResponse {
    ...
    @Schema(description = "Tamanho formatado (ex: 1.5 MB)")
    ...
    @Schema(description = "Nome do usuário que criou")
    private String criadoPorNome;

    @Schema(description = "ID do usuário que excluiu (se aplicável)")
    private UUID excluidoPor;

    @Schema(description = "Nome do usuário que excluiu (se aplicável)")
    private String excluidoPorNome;

    @Schema(description = "URL da miniatura (se for imagem)")
    private String thumbnailUrl;

    @Schema(description = "Indica se é uma imagem")
    private Boolean isImagem;

    @Schema(description = "Extensão do arquivo")
