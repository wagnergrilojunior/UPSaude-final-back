...
class UsuariosSistemaAtualizacaoRegressionTest extends BaseRegressionTest {
    ...
    @Test
    void atualizacaoMinimaDeUsuariosSistemaNaoPodeQuebrar() throws Exception {
    ...
    @Test
    void atualizacaoCompletaDeUsuariosSistemaNaoPodeQuebrar() throws Exception {
        String email = gerarEmailUnico();
        String username = gerarUsernameUnico();
        String jsonPayload = String.format("""
                {
                  ...
                  "dadosExibicao": {
                    "nomeExibicao": "Usuario Atualizado Completo",
                    "fotoUrl": "https://example.com/foto-atualizada.jpg"
                  },
                  "configuracao": {
                    "adminTenant": false,
        ...
        String jsonPayload = String.format("""
                {
                  ...
                  "dadosExibicao": {
                    "nomeExibicao": "Usuario Atualizado Todos Campos",
                    "fotoUrl": "https://example.com/foto-completa-atualizada.jpg"
                  },
                  "configuracao": {
                    "adminTenant": true,
