...
class TenantCadastroRegressionTest extends BaseRegressionTest {
  ...
  @Test
  void cadastroComCodigoIbgeMunicipioNaoPodeQuebrar() throws Exception {
    String slug = gerarSlugUnico();
    String cnpj = gerarCnpjUnico();
    String telefone = gerarTelefoneValido();
    String jsonPayload = String.format("""
        {
          ...
          "dadosIdentificacao": {
            "nome": "Tenant Teste com Código IBGE",
            "descricao": "Tenant de teste com código IBGE do município de São Paulo",
            "cnpj": "%s"
          },
          "contato": {
            "telefone": "%s",
            "email": "contato@tenant-ibge.com",
            "site": "https://www.tenant-ibge.com"
          },
          "dadosFiscais": {
            "inscricaoEstadual": "123456789",
            "inscricaoMunicipal": "987654321"
