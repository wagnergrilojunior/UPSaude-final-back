...
class TenantAtualizacaoRegressionTest extends BaseRegressionTest {
  ...
  @Test
  void atualizacaoComCodigoIbgeValidoNaoPodeQuebrar() throws Exception {
    String slug = gerarSlugUnico();
    String cnpj = gerarCnpjUnico();
    String jsonPayload = String.format("""
        {
          ...
          "dadosIdentificacao": {
            "nome": "Tenant Atualizado com Código IBGE",
            "cnpj": "%s"
          }
        }
        """, slug, cnpj);
  ...
  @Test
  void atualizacaoComCodigoIbgeInvalidoDeveRetornar400() throws Exception {
    String slug = gerarSlugUnico();
    String jsonPayload = String.format("""
        {
          "slug": "%s",
          ...
          "dadosIdentificacao": {
            "nome": "Tenant com Código IBGE Inválido"
          }
        }
        """, slug);
  ...
  @Test
  void atualizacaoRemoverCodigoIbgeNaoPodeQuebrar() throws Exception {
    String slug = gerarSlugUnico();
    String jsonPayload = String.format("""
        {
          "slug": "%s",
          "dadosIdentificacao": {
            "nome": "Tenant sem Código IBGE"
          }
        }
        """, slug);
