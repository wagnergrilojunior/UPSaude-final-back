...
class PacienteAtualizacaoErroRegressionTest extends BaseRegressionTest {
        ...
        String jsonPayload = """
                {
                  "dadosPessoaisBasicos": {
                    "nomeCompleto": "Paciente Para Teste Erro",
                    "sexo": "MASCULINO"
                  }
                }
                """;
    ...
    @Test
    void pacienteAtualizadoSemNomeSempreRetorna400() throws Exception {
        String jsonPayload = """
                {
                  "dadosPessoaisBasicos": {
                    "sexo": "FEMININO"
